...
= ~The elves made their choice. Don't waste your time on them, we've trouble enough ahead. Another city's worth of it.~
...
/* Talk 3 - Post Saradush's Destruction */
CHAIN IF ~Global("BFSMk2Ashes","GLOBAL",1)~ THEN BFSMK25J BFSMk.AshAndSilence
~Saradush is gone. Wasn't much of a city to start with but still.~ 
= ~Spirits won't rest easily there. Too much blood, too much pain lingering in the air.~ 
= ~Guess that's inevitable. Gods fights and mortals die. Rest of us are left to pick up the pieces.~
END
++ ~I wish we could have saved more people.~ EXTERN BFSMK25J BFSMk2.WeTried
++ ~Mortals or gods, the strong survive and the weak perish. That's the reality of the life.~ EXTERN BFSMK25J BFSMk2.Survival
++ ~Best not to linger on what-ifs. We have more battles ahead.~ EXTERN BFSMK25J BFSMk2.MoveOn

CHAIN BFSMK25J BFSMk2.WeTried
~Can't save everyone. You did what you could, most can't even claim that.~
END
IF ~~ EXTERN BFSMK25J BFSMk2.MovingAlongToEnd

CHAIN BFSMK25J BFSMk2.Survival
~Can't say I like it but I know it true enough.~
END
IF ~~ EXTERN BFSMK25J BFSMk2.MovingAlongToEnd

CHAIN BFSMK25J BFSMk2.MoveOn
~You're right. Can't fight tomorrow's fight with yesterday's ghosts on your back.~
END
IF ~~ EXTERN BFSMK25J BFSMk2.MovingAlongToEnd

CHAIN BFSMK25J BFSMk2.MovingAlongToEnd
~But let's make sure we're not leaving more ashes behind us than we have to.~
DO ~SetGlobal("BFSMk2Ashes","GLOBAL",2)~
EXIT
...
== BFSMK25J IF ~InParty("BFSMK") InMyArea("BFSMK") !StateCheck("BFSMK",CD_STATE_NOTVALID)~ THEN ~The spirits whisper about her. Some scream even. That's never a good sign. Might be she's mad, but strength still clings to her bones.~
END
